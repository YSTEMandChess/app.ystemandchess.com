...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */function D(e){var t=[],r=new Map;function n(t){var n=r.get(t);if(!n){var o=e(t);r.set(t,n=o.then(j))}return n}return P.forEach((function(e,r){var o=[];e.templateUrl&&o.push(n(e.templateUrl).then((function(t){e.template=t})));var i=e.styleUrls,s=e.styles||(e.styles=[]),u=e.styles.length;i&&i.forEach((function(t,r){s.push(""),o.push(n(t).then((function(n){s[u+r]=n,i.splice(i.indexOf(t),1),0==i.length&&(e.styleUrls=void 0)})))}));var c=Promise.all(o).then((function(){return function e(t){S.delete(t)}
/**
     * @license
     * Copyright Google Inc. All Rights Reserved.
     *
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */(r)}));t.push(c)})),F(),Promise.all(t).then((function(){}))}var P=new Map,S=new Set;function N(e){return S.has(e)}function F(){var e=P;return P=new Map,e}function j(e){return"string"==typeof e?e:e.text()}var R=0,A=function(){function e(){this._references=new Map}return e.prototype.overrideMetadata=function(e,r,n){var o={};if(r&&function i(e){var t=[];Object.keys(e).forEach((function(e){e.startsWith("_")||t.push(e)}));for(var r=e;r=Object.getPrototypeOf(r);)Object.keys(r).forEach((function(e){var n=Object.getOwnPropertyDescriptor(r,e);!e.startsWith("_")&&n&&"get"in n&&t.push(e)}));return t}
/**
     * @license
     * Copyright Google Inc. All Rights Reserved.
     *
...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */,e.ɵMetadataOverrider=A,e.ɵTestingCompiler=se,e.ɵTestingCompilerFactory=ue,e.ɵangular_packages_core_testing_testing_a=le,e.ɵangular_packages_core_testing_testing_b=re,e.ɵangular_packages_core_testing_testing_c=ne,Object.defineProperty(e,"__esModule",{value:!0})}));