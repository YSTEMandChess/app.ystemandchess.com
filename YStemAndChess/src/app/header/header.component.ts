...
export class HeaderComponent implements OnInit {
  ...
  async ngOnInit() {
    ...
    const notAllowedExtsNotLoggedIn: String[] = ["/parent", "/student", "/play-mentor", "/admin"];
    const notAllowedExtsStudent: String[] = ["/parent", "/play-mentor", "/signin", "/login", "/admin"];
    const notAllowedExtsParent: String[] = ["/student", "/play-mentor", "/signin", "/login", "/admin"];
