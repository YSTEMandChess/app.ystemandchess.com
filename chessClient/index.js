...
var board = null;
var game = new Chess();
//var $status = $('#status')//var $fen = $('#fen')//var $pgn = $('#pgn')var eventMethod = window.addEventListener ? "addEventListener" : "attachEvent";
...
function letParentKnow() {
  ...
  function onDragStart(source, piece, position, orientation) {
    // do not pick up pieces if the game is over  if (isLesson == false) {
    if (game.game_over()) {
      sendGameOver();
      return false;
    }
