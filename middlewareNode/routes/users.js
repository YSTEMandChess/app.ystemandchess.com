...
// @route   POST /user/timeTracking/start
// @desc    POST a user's event for time tracking
// @access  Public with jwt Authentication
router.post("/timeTracking/start", passport.authenticate("jwt"), async (req, res) => {
  try{
...
// @route   PUT /user/timeTracking/end
// @desc    PUT a user's event to an end
// @access  Public with jwt Authentication
router.put("/timeTracking/end", passport.authenticate("jwt"), async (req, res) => {
  try{
